...
#Load Data####
setwd("C:/Users/soc-csw/Dropbox/Teaching/Introduction to R METHODS WORKSHOP/2025/Day 4")

library(readr)
moral_issues <- read_csv("C:/Users/soc-csw/Dropbox/Teaching/Introduction to R METHODS WORKSHOP/2025/Day 2/gss-moral-issues.csv")
...
# Sample 1000 rows from the diamonds dataset
